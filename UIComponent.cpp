...
: Component(owner)
{
	gGame.GetRenderer()->AddUIComp(this);
}

UIComponent::~UIComponent()
{
	gGame.GetRenderer()->RemoveUIComp(this);
}
...
void UIComponent::DrawTexture(const Shader* shader, const Texture* texture, const Vector2& offset,
